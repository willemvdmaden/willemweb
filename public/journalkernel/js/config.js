...
window.JK_CONFIG = {
    ...
    SUPABASE_URL: 'https://latczkvhtvaqkjrkbyqw.supabase.co',
    // Project publishable (public) key from the Supabase dashboard.
    SUPABASE_ANON_KEY: 'sb_publishable_89lYpKSFM_5yxzF0PikCjQ_q2uphAiE',
    // https://<project-ref>.supabase.co/functions/v1
    FUNCTIONS_URL: 'https://latczkvhtvaqkjrkbyqw.supabase.co/functions/v1'
};
